...
2.  What imaging activities are affected by the discrepant observation, and how should those be handled prior to reconciliation (e.g. protocol selection, post processing, report content)?
