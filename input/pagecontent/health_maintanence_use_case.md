# x.1 Health maintenance screening laboratory use case
...
## x.1.5 Workflow/Storyboard:
### x.1.5.1 Administrative update and record change
...
#### x.1.5.1.1 Administrative update and record change workflow
 


### x.1.5.2	Health screening automated process
...
#### x.1.5.2.1 Health screening automated process workflow
 
### x.1.5.3	Clinic appointment arrival and check-in
...
#### x.1.5.3.1 Clinic appointment arrival and check-in workflow
 

### x.1.5.4	Patient encounter and examination
...
#### x.1.5.4.1 Patient encounter and examination workflow
 
### x.1.5.5	Review of lab results 
...
#### x.1.5.5.1	Review of lab results workflow
